 ...
 *
 *   STEP_1 → identify encoding type  (answer: "base64")
 *   STEP_2 → find hidden variable    (answer: "SECRET_KEY")
 *   STEP_3 → extract seed value      (answer: dynamic seed)
 *
 * /submit requires NO flag input — flag is generated server-side after all steps pass.
 */
