// src/modules/practice-labs/cryptography/cryptography.module.ts
...
@Module({
  ...
  providers: [Lab1Service, Lab2Service, Lab3Service, PracticeLabStateService, HintPenaltyService, FlagRecordService],
})
